...
def get_list(base_folder, pattern='*.jpg'):
...
class MyConfig(Config):
    ...
    class_names = ["mug_black", "mug_gray", "cocacola", "pringles"]
    ...
    generate_master_informations = False
...
class MyDataset(utils.Dataset):
    ...
    def __init__(self):
        ...
        self.source_image_path_list = get_list(self.base_folder, pattern=config.image_filename_pattern)
        ...
        self.source_image_path_list = self.source_image_path_list
        num_source_images = len(self.source_image_path_list)
    ...
    def load_mask(self, image_id):
        ...
        for current_dict in labels_dicts:
            if current_dict['label_class'] is not None:
